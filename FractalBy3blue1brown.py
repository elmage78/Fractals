...
from Formulae import coefficients_to_roots
from Formulae import roots_to_coefficients
from Formulae import dpoly
from Formulae import poly
...
class RealNewtonsMethod(Scene):
    ...
    def add_title(self, axes, opacity=0):
        ...
        poly = Text(f"P({self.poly_tex[0]}) = ", self.poly_tex, "= 0 ")
    ...
    def draw_graph(self):
        ...
        self.play(
            Create(self.poly[:-1], color=self.graph_color, run_time=2),
            Create(rect, run_time=2),
            Create(self.graph, run_time=4),
        )
        self.wait()
        self.play(
...
class FactorPolynomial(RealNewtonsMethodHigherGraph):
    ...
    def show_factors(self):
        ...
        words = Text("Potentially complex\\\\", "$r_n = a_n + b_n i$")
